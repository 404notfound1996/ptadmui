package com.goshine.ptadmui.core.datasource.aop;

import com.goshine.ptadmui.core.datasource.annotation.EnableAutoDynamicDataSource;
import com.goshine.ptadmui.core.datasource.annotation.TargetDataSource;
 ...
 * 当EnableAutoDynamicDataSource注解未生效不进行接口拦截
 * @author 李涛
 * @Date 2019年11月5日
 */
@Aspect
...
public class DynamicDataSourceAspect {
     ...
     * 数据源变更拦截器
     */
    @Before(value = "@annotation(com.goshine.ptadmui.core.datasource.annotation.TargetDataSource) && @annotation(targetDataSource)")
    ...
    @After(value = "@annotation(com.goshine.ptadmui.core.datasource.annotation.TargetDataSource) && @annotation(targetDataSource)")
    @AfterThrowing(value = "@annotation(com.goshine.ptadmui.core.datasource.annotation.TargetDataSource) && @annotation(targetDataSource)")
