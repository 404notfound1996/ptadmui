package com.goshine.ptadmui.core.datasource.register;

import com.google.common.base.Preconditions;
import com.goshine.ptadmui.core.datasource.DynamicDataSource;
...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    private void initOtherDataSources(Environment env) throws Exception{
       ...
       if(StringUtils.isBlank(datasourceNames)){
           throw new Exception("未发现数据源配置，请检查配置：slave.datasource.names");
       }
